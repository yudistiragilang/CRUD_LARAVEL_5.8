...
<!--<![endif]-->
	...
	<head>
		...
		<link rel="stylesheet" type="text/css" href="{{asset('public/polished/polished.min.css')}}">
		<link rel="stylesheet" type="text/css" href="{{ asset('public/polished/iconic/css/open-iconic-bootstrap.min.css') }}">
		<style type="text/css">
			.grid-highlight{
				padding-top: 1rem;
				padding-bottom: 1rem;
	...
	<body>
		...
		<nav class="navbar navbar-expand p-0">
			<a class="navbar-brand text-center col-xs-12 col-md-3 col-lg-2 mr-0" href="index.php"> Larashop </a>
			...
			<div style="min-height: 100%" class="flex-row d-flex align-items-stretch m-0">
				<div class="polished-sidebar bg-light col-12 col-md-3 col-lg-2 p-0 collapse d-md-inline" id="sidebar-nav">
					...
					<ul class="polished-sidebar-menu ml-0 pt-4 p-0 d-md-block">
						...
						<li>
							<a href="/aquascape"><span class="oi oi-home"></span>Home</a>
						</li>
						<li>
