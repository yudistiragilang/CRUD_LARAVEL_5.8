...
class BookController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->get('save_action') == 'PUBLISH') {
            ...
            return redirect()->route('books.index')->with('status', 'Book successfully saved adn published');

        } else {

            return redirect()->route('books.index')->with('status', 'Book successfully saved as draft');
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('books.index', ['id'=>$book->id])->with('status', 'Book successfully updated');
